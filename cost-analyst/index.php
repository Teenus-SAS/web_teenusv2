...
<head>
    ...
    <meta name="keywords" content="Analista de Costos, Fijacion de precios, Costeo, manufactura, fabricas, presupuesto, inventario" />
    ...
    <title>Analista de costos Freelance</title>
    <!-- Google Fonts -->
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <?php include_once dirname(__DIR__) . '/cost-analyst/partials/nav.php' ?>
        <?php include_once dirname(__DIR__) . '/cost-analyst/modules/banner.php' ?>
        <?php include_once dirname(__DIR__) . '/cost-analyst/modules/works.php' ?>
        <?php include_once dirname(__DIR__) . '/cost-analyst/modules/about.php' ?>
        <?php include_once dirname(__DIR__) . '/cost-analyst/modules/overview.php' ?>
        ...
        <?php include_once dirname(__DIR__) . '/cost-analyst/modules/contact.php' ?>
        <?php //include_once dirname(__DIR__) . '/cost-analyst/modules/map.php' 
        ?>
