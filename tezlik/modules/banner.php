        ...
        <div class="row d-flex align-items-center">
            <div class="col-12 col-md-7 col-lg-6">
                <div class="text-left home-content z-index position-relative">
                    ...
                    <h2 style="color:white">Cotiza fácil y rápido con tus costos precisos de producción y una asesoría personalizada para incrementar tu rentabilidad y beneficios.</h4>
