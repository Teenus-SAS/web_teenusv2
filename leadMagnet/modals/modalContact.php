<div class="modal fade" id="modalContact" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <button type="button" class="close closeModal" aria-label="Close" style="margin-right: 20px;margin-top: 20px;">
                <span aria-hidden="true">&times;</span>
            </button>
            <div class="section-title" style="border-bottom: 1px solid #dee2e6;">
                        ...
                        <div class="contact-info">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="d-flex">
                                        <div class="icon">
                                            <div class="works-icon"><span class="pulse-p"><i class="fa fa-map-marker"></i></span></div>
                                        </div>
                                        <div class="c-area">
                                            <span>Dirección</span> Cra &amp; 55cbis #160-18 p2 <br /> Bogotá, Colombia
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="d-flex">
                                        <div class="icon">
                                            <div class="works-icon"><span class="pulse-g"><i class="fa fa-envelope"></i></span></div>
                                        </div>
                                        <div class="c-area">
                                            <span>Email</span>
                                            <div class="c-area">
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex">
                                        <div class="icon">
                                            <div class="works-icon"><span class="pulse-o"><i class="fa fa-phone"></i></span></div>
                                        </div>
                                        <div class="c-area">
                                            <span>Phone</span>
                                            <div class="c-area">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btnSendContact">Enviar</button>
