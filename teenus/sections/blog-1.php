...
<head>
	...
	<!-- Bootstrap Min CSS -->
	<link rel="stylesheet" href="/teenus/teenus/assets/css/bootstrap.min.css">
	<!-- Animate Min CSS -->
...
<body>
	...
	<!-- Start Navbar Area -->
	<?php include_once dirname(dirname(__DIR__)) . '/teenus/partials/nav.php' ?>
	<!-- End Navbar Area -->
					...
					<div class="blog-item">
						<div class="blog-image">
							<a href="single-blog.html">
								<img src="teenus/teenus/assets/img/blog/blog-1.jpg" alt="image">
							</a>
						</div>
