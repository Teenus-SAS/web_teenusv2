        ...
        <div class="container">
            <nav class="navbar navbar-expand-md navbar-light">
                ...
                <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a href="/" class="nav-link">Inicio <!-- <i class="fas fa-chevron-down"></i> --></a>
                        ...
                        <li class="nav-item">
                            <a href="/develop/index.php" class="nav-link">Desarrollo de Software<!--  <i class="fas fa-chevron-down"></i> --></a>
                            <!-- <ul class="dropdown-menu">
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="/tezlik/index.php" class="nav-link">Automatice sus costos y precios<!--  <i class="fas fa-chevron-down"></i> --></a>
                            <!-- <ul class="dropdown-menu">
                                <li class="nav-item">
                        ...
                        <!-- <li class="nav-item">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item">
                                    <a href="/teenus/sections/blog-1.php" class="nav-link">Blog Grid</a>
                                </li>
                                <li class="nav-item">
                                    <a href="/teenus/sections/blog-2.html" class="nav-link">Blog Right Sidebar</a>
                                </li>
                                <li class="nav-item">
                                    <a href="/teenus/sections/single-blog.html" class="nav-link">Blog Details</a>
                                </li>
                            </ul>
                        </li> -->
                        <!-- <li class="nav-item">
                            <a href="#contact-section" class="nav-link">Contactenos</a>
                        </li> -->
                    </ul>
