$(document).ready(function () {
  ...
  /* Ajustas posición tabla */
  // document.getElementsByClassName('dataTables_filter').style.marginLeft =
  //   '400px';
  // $('.dataTables_filter').css('margin-left', '400px');
  // $('#tblArticles_paginate').css('margin-left', '500px');
