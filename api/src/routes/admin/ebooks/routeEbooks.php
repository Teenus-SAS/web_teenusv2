...
// $app->post('/addEbook', function (Request $request, Response $response, $args) use ($ebooksDao, $publicationsDao) {
...
//         $publications = $publicationsDao->insertPublication($lastEbook, $dataEbook);
