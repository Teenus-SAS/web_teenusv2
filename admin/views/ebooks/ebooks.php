                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-5 col-xl-6">
                                <div class="page-title">
                                    <h3 class="mb-1 font-weight-bold text-dark">Ebooks</h3>
                                    <ol class="breadcrumb mb-3 mb-md-0">
                                        <li class="breadcrumb-item active">Administración de Ebooks</li>
                                    </ol>
                                </div>
                            </div>
                            <div class="col-sm-7 col-xl-6">
                                <div class="form-inline justify-content-sm-end" style="display:flex">
                                    <button class="btn btn-warning" id="btnNewEbooks" name="btnNewEbooks">Crear</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-striped" id="tblEbooks">
